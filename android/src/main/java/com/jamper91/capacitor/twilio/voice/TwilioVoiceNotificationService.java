...
public class TwilioVoiceNotificationService extends Service {

    private static final String TAG = TwilioVoiceNotificationService.class.getSimpleName();
    @Override
...
//                    accept(callInvite, notificationId);
                    TwilioVoicePlugin.callAccepted(callInvite, notificationId);
                    break;
                case Constants.ACTION_REJECT:
//                    reject(callInvite);
                    TwilioVoicePlugin.callRejected(callInvite);
                    break;
                case Constants.ACTION_CANCEL_CALL:
//                    handleCancelledCall(intent);
                    TwilioVoicePlugin.callCanceled();
                    break;
                default:
                    break;
            }
...
//
//        Intent intent = new Intent(this, TwilioPlugin.class);
...
//            return buildNotification("Your reader is calling.",
//                    pendingIntent,
//                    extras,
//                    callInvite,
//                    notificationId,
...
//                    .setContentTitle("LifeReader")
//                    .setContentText("Your reader is calling.")
//                    .setAutoCancel(true)
//                    .setExtras(extras)
...
//
//        Intent acceptIntent = new Intent(getApplicationContext(), TwilioPlugin.class);
...
//        endForeground();
//        Intent activeCallIntent = new Intent(this, TwilioPlugin.class);
...
//        TwilioPlugin.handleIncomingCallIntent(intent);
//    }
//
